...
declare function createRequestInstance(baseURL: string, Authorization?: string, withoutAuthorization?: boolean): ReturnType<typeof createClient<paths>>;
 ...
 */
declare const auth: (_request: RequestInstance) => {
    token: (body: paths["/login/api-secret"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    tokenRefresh: (body: paths["/token/refresh"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
};
 ...
 */
declare const payments: (_request: RequestInstance, options?: {
    storeId?: string;
}) => {
    preRegisterPayment: (body: paths["/payments/{paymentId}/pre-register"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/pre-register"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    getPayment: (params: paths["/payments/{paymentId}"]["get"]["parameters"]["path"]) => ReturnType<RequestInstance["GET"]>;
    getPayments: (body?: components["schemas"]["GetPaymentsBody"]) => ReturnType<RequestInstance["GET"]>;
    getPaymentsByCursor: (body?: components["schemas"]["GetAllPaymentsByCursorBody"]) => ReturnType<RequestInstance["GET"]>;
    cancelPayment: (body: paths["/payments/{paymentId}/cancel"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/cancel"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    payWithBillingKey: (body: paths["/payments/{paymentId}/billing-key"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/billing-key"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    keyInPayment: (body: paths["/payments/{paymentId}/instant"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/instant"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    closeVbank: (params: paths["/payments/{paymentId}/virtual-account/close"]["post"]["parameters"]["path"]) => ReturnType<RequestInstance["POST"]>;
    resendWebhook: (body: paths["/payments/{paymentId}/resend-webhook"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/resend-webhook"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    registerStoreReceipt: (body: paths["/payments/{paymentId}/register-store-receipt"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/register-store-receipt"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
};
 ...
 */
declare const escrow: (_request: RequestInstance, options?: {
    storeId?: string;
}) => {
    registerEscrowLogistics: (body: paths["/payments/{paymentId}/escrow/logistics"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/escrow/logistics"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    updateEscrowLogistics: (body: paths["/payments/{paymentId}/escrow/logistics"]["patch"]["parameters"]["path"] & paths["/payments/{paymentId}/escrow/logistics"]["patch"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["PATCH"]>;
    confirmEscrow: (body: paths["/payments/{paymentId}/escrow/complete"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/escrow/complete"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
};
 ...
 */
declare const paymentSchedules: (_request: RequestInstance, options?: {
    storeId?: string;
}) => {
    getPaymentSchedule: (params: paths["/payment-schedules/{paymentScheduleId}"]["get"]["parameters"]["path"]) => ReturnType<RequestInstance["GET"]>;
    getPaymentSchedules: (body?: components["schemas"]["GetPaymentSchedulesBody"]) => ReturnType<RequestInstance["GET"]>;
    revokePaymentSchedule: (body: components["schemas"]["RevokePaymentSchedulesBody"]) => ReturnType<RequestInstance["DELETE"]>;
    schedulePayment: (body: paths["/payments/{paymentId}/schedule"]["post"]["parameters"]["path"] & paths["/payments/{paymentId}/schedule"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
};
 ...
 */
declare const billingKeys: (_request: RequestInstance, options?: {
    storeId?: string;
}) => {
    getBillingKey: (params: paths["/billing-keys/{billingKey}"]["get"]["parameters"]["path"]) => ReturnType<RequestInstance["GET"]>;
    deleteBillingKey: (params: paths["/billing-keys/{billingKey}"]["delete"]["parameters"]["path"]) => ReturnType<RequestInstance["DELETE"]>;
    getBillingKeys: (body: components["schemas"]["GetBillingKeyInfosBody"]) => ReturnType<RequestInstance["GET"]>;
    issueBillingKey: (body: paths["/billing-keys"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
};
 ...
 */
declare const cashReceipts: (_request: RequestInstance, options?: {
    storeId?: string;
}) => {
    getCashReceipt: (params: paths["/payments/{paymentId}/cash-receipt"]["get"]["parameters"]["path"]) => ReturnType<RequestInstance["GET"]>;
    issueCashReceipt: (body: paths["/cash-receipts"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    cancelCashReceipt: (params: paths["/payments/{paymentId}/cash-receipt/cancel"]["post"]["parameters"]["path"]) => ReturnType<RequestInstance["POST"]>;
};
 ...
 */
declare const identityVerifications: (_request: RequestInstance, options?: {
    storeId?: string;
}) => {
    getIdentityVerification: (params: paths["/identity-verifications/{identityVerificationId}"]["get"]["parameters"]["path"]) => ReturnType<RequestInstance["GET"]>;
    sendIdentityVerification: (body: paths["/identity-verifications/{identityVerificationId}/send"]["post"]["parameters"]["path"] & paths["/identity-verifications/{identityVerificationId}/send"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    confirmIdentityVerification: (body: paths["/identity-verifications/{identityVerificationId}/confirm"]["post"]["parameters"]["path"] & paths["/identity-verifications/{identityVerificationId}/confirm"]["post"]["requestBody"]["content"]["application/json"]) => ReturnType<RequestInstance["POST"]>;
    resendIdentityVerification: (params: paths["/identity-verifications/{identityVerificationId}/resend"]["post"]["parameters"]["path"]) => ReturnType<RequestInstance["POST"]>;
};
 ...
 */
declare const forSpecificPg: (_request: RequestInstance) => {
    getKakaopayPaymentOrder: (query: paths["/kakaopay/payment/order"]["get"]["parameters"]["query"]) => ReturnType<RequestInstance["GET"]>;
};
...
declare class PortOne {
    ...
    escrow: ReturnType<typeof escrow>;
    paymentSchedules: ReturnType<typeof paymentSchedules>;
    billingKeys: ReturnType<typeof billingKeys>;
    cashReceipts: ReturnType<typeof cashReceipts>;
    identifyVerifications: ReturnType<typeof identityVerifications>;
    forSpecificPg: ReturnType<typeof forSpecificPg>;
    private _request;
    constructor(options?: {
        host: string;
    });
...
export { PortOne, PortOne as default };
